<?php
namespace i2i8\wising\components;
 ...
 */
abstract class BaseWechat extends \yii\base\Component
{
    /**
     * Access Token更新后事件
     */
    ...
    protected function http($url, $options = [])
    {
        $options = [
            ...
            CURLOPT_SSLVERSION =>  1// CURL_SSLVERSION_TLSv1微信官方屏蔽了ssl2和ssl3, 启用更高级的ssl
        ] : []) + $options;
